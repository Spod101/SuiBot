...
/** Returns the current date broken into parts in the Asia/Manila timezone. */
...
/**
 * Returns how many calendar days a date (YYYY-MM-DD) is away from today
 * in the Asia/Manila timezone. Negative = in the past.
 */
...
/** e.g. "April 14, 2026" from a YYYY-MM-DD string. */
...
/**
 * Builds a human-readable countdown string for a camp event.
 * e.g. "April 20, 2026 | 6 Days to go (~1 Week)"
 *      "April 14, 2026 | Today!"
 *      "April 10, 2026 | 4 Days ago"
 */
